...
{
    public class DexDorugamon_BT17_065 : CEntity_Effect
    {
        public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
        {
            ...
            if (timing == EffectTiming.None)
            {
                ...
                {
                    return targetPermanent.TopCard.ContainsCardName("Dorugamon") &&
            ...
            if (timing == EffectTiming.WhenPermanentWouldBeDeleted)
            {
                ...
                bool IsOwnerPermanentCondition(Permanent permanent)
                {
                    return CardEffectCommons.IsPermanentExistsOnOwnerBattleAreaDigimon(permanent, card) &&
                           permanent.TopCard.ContainsCardName("Dorugamon") &&
            ...
            if (timing == EffectTiming.OnEnterFieldAnyone)
            {
                ...
                bool IsDoruCardCondition(CardSource cardSource)
                {
                    return cardSource.IsDigimon &&
                           cardSource.ContainsCardName("Dorugamon") &&
