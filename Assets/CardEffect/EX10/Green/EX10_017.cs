            ...
            if (timing == EffectTiming.None)
            {
                ...
                AppFusionCondition GetAppFusion(CardSource cardSource)
                {
                    bool linkCondition(Permanent permanent, CardSource source)
                    {
                        ...
                        {
                            if (permanent.TopCard.EqualsCardName("Mirrormon"))
                            {
                                if (permanent.LinkedCards.Find(x => x.EqualsCardName("Kabemon") || x.EqualsCardName("Copipemon")))
                                {
                                    return true;
                                }
                            }

                            if (permanent.TopCard.EqualsCardName("Kabemon"))
                            {
                                if (permanent.LinkedCards.Find(x => x.EqualsCardName("Mirrormon") || x.EqualsCardName("Copipemon")))
                                {
                                    return true;
                                }
                            }

                            if (permanent.TopCard.EqualsCardName("Copipemon"))
                            {
                                if (permanent.LinkedCards.Find(x => x.EqualsCardName("Mirrormon") || x.EqualsCardName("Kabemon")))
                                {
                                    return true;
                                }
                            }
