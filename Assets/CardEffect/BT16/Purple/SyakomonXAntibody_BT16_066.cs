...
{
    public class SyakomonXAntibody_BT16_066 : CEntity_Effect
    {
        public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
        {
            ...
            #region Start of Main / When Digivolving
            if (timing == EffectTiming.OnStartMainPhase || timing == EffectTiming.OnEnterFieldAnyone)
            {
                ...
                {
                    return "[Start of Your Main Phase] [When Digivolving] Your opponent may trash 1 Digimon card in their hand. If they don't, gain 1 memory.";
                }
