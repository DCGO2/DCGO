...
public class CardSource : MonoBehaviour
{
    ...
    public List<string> BaseCardNames
    {
        get
        {
            ...
            if (!isPermanent && _cEntity_Base.OptionCardName != null)//Dual Cards cannot reference Option card side details while a permanent
            {
                baseCardNames.Add(_cEntity_Base.OptionCardName);
            }
    ...
    public bool HasText(string text)
    {
        ...
        List<string> checkStrings = new List<string>()
        {
            ...
            DataBase.ReplaceToASCII(_cEntity_Base.OptionCardName),
