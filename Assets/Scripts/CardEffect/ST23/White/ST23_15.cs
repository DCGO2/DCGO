...
namespace DCGO.CardEffects.ST23
{
    public class ST23_15 : CEntity_Effect
    {
        public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
        {
            ...
            string SharedEffectName = "Play 1 [BEATBREAK] card with a play cost of 4 or less from hand or trash for free, place this card in battle area";

            string SharedEffectDescription(string tag) => $"[{tag}] You may play 1 [BEATBREAK] trait card with a play cost of 4 or less from your hand or trash without paying the cost. Then, place this card in the battle area.";
