...
public class P_067 : CEntity_Effect
{
    public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
    {
        ...
        if (timing == EffectTiming.SecuritySkill)
        {
            ...
            {
                return "[Security] At the end of the battle, <Draw 2>. (Draw 2 cards from your deck.) Then, add this card to its owner's hand.";
            }
            ...
            IEnumerator ActivateCoroutine(Hashtable _hashtable)
            {
                ...
                {
                    return "<Draw 2>. (Draw 2 cards from your deck.) Then, add this card to its owner's hand.";
                }
