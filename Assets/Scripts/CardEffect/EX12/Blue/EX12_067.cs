...
{
    public class EX12_067 : CEntity_Effect
    {
        public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
        {
            ...
            if (timing == EffectTiming.OnAllyAttack)
            {
                ...
                {
                    return "[Your Turn] When one of your Digimon with [Jellymon] in its text or the [DS] trait attacks, by suspending this Tamer, activate 1 of the effects below:\r\n- It my digivolve into a level 6 or lower card with [Jellymon] in its text or the [DS] trait in the hand with the cost reduced by 1.\r\n- You may use 1 Option card with [Jellymon] in its text or the [DS] trait from your hand with the cost reduced by 2.";
                }
