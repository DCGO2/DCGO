...
public class BT9_085 : CEntity_Effect
{
    public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
    {
        ...
        if (timing == EffectTiming.OnUnTappedAnyone)
        {
            ...
            string EffectDiscription()
            {
                return "[Your Turn] When one of your blue or red Digimon becomes unsuspended, you may suspend this Tamer to return 1 of your opponentÅ's level 3 Digimon to its ownerÅ's hand.";
            }
