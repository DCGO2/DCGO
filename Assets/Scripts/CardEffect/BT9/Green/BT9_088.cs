...
public class BT9_088 : CEntity_Effect
{
    public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
    {
        ...
        if (timing == EffectTiming.OnEndBattle)
        {
            ...
            string EffectDiscription()
            {
                return "[All Turns] When one of your green or blue Digimon deletes an opponentÅ's Digimon in battle and survives, you may suspend this Tamer to <Draw 1>. (Draw 1 card from your deck.)";
            }
