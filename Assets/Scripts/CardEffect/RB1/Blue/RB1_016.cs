...
public class RB1_016 : CEntity_Effect
{
    public override List<ICardEffect> CardEffects(EffectTiming timing, CardSource card)
    {
        ...
        if (timing == EffectTiming.OnAllyAttack)
        {
            ...
            {
                return "[When Attacking] You may trash up to 2 blue cards in your hand. For each one, trash any 1 card under your opponent's Digimon or Tamers. Then, you may return 1 of your opponentfDigimon with no digivolution cards to the bottom of the deck.";
            }
        ...
        if (timing == EffectTiming.OnEnterFieldAnyone)
        {
            ...
            string EffectDiscription()
            {
                return "[When Digivolving] You may trash up to 2 blue cards in your hand. For each one, trash any 1 card under your opponent's Digimon or Tamers. Then, you may return 1 of your opponentfDigimon with no digivolution cards to the bottom of the deck.";
            }
